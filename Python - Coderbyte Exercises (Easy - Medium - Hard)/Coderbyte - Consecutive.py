...
# to make it a consecutive array of numbers from 4 to 8. Negative numbers may be entered as parameters
# and no array will have less than 2 elements.


def Consecutive(arr):

  alls = set(range(min(arr), max(arr)+1))
  return len(alls - set(arr))
